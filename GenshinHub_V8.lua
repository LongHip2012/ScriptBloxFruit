...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Genshin Hub Notification", 
        Text = tostring(value),
        Icon = "http://www.roblox.com/asset/?id=15891628629",
        Duration = 10
    })
end
function Com()
...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		ToggleImgUi.Image = "rbxassetid://15891628629"
	...
	ImageLabelfps.Image = "rbxassetid://15891628629"
	...
	ImageLabeltime.Image = "rbxassetid://15891628629"
...
local win = library:Window("Genshin Hub",[[ BLACK]],[[Ver: 8.0.400.0]],"15891628629",Enum.KeyCode.RightControl)
