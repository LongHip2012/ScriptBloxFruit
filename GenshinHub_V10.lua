...
local Window = OrionLib:MakeWindow({Name = "Genshin Hub | Ver 10.0.400.2", HidePremium = false, IntroText = "Genshin Hub | Ver 10.0.400.2", SaveConfig = true, ConfigFolder = "Specialized"})
...
OrionLib:MakeNotification({
	Name = "Genshin Hub",
	Content = "Genshin Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
