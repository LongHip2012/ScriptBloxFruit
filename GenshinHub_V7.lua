...
mainopens.Parent = mainopen
 ...
 loki.Image = "rbxassetid://18324951997"
...
--------------------------------------------------------------------
local Library = Update:Window("GENSHIN HUB ","")
------------------------------------------
...
wait(1)
Notification:Notify(
   {Title = "GENSHIN HUB", Description = "You Have Max Observation"},
